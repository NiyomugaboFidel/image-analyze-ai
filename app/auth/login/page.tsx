          ...
          <Card className="w-full max-w-md shadow-lg border-border dark:border-zinc-800 bg-card dark:bg-zinc-900">
            ...
            <CardContent className="space-y-4">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  className="w-full py-3 text-lg rounded-xl font-semibold bg-gradient-to-r from-purple-500 to-blue-500 hover:from-blue-500 hover:to-purple-500 text-white shadow-lg transition-all duration-200"
                  disabled={loading}
                >
